...
program
	...
	.option('-v, --vars <vars>', 'A way of injecting environment vars into the VCL and backend configuration.  So if you pass --vars AUTH_KEY,FOO the values {$AUTH_KEY} and ${FOO} in the config will be replaced with the values of the environment variable.  If you include SERVICEID it will be populated with the current --service option', list)
